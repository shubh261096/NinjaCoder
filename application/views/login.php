...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Sign in to continue to TiredBuzz</h1>
            <div class="account-wall">
                ...
                <?php echo form_open('Admin/login', ['role'=>'form' , 'class'=>'form-signin'] ); ?>
            ...
            <a href="<?php echo base_url('UserLogin');?>" class="text-center new-account">Click here for user login</a>
        </div>
    </div>
</div>
